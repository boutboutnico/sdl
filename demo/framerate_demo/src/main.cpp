...
int main(int argc, char** argv)
{
	...
	static const string title = "Ma premiere application SDL2";
	...
	try
	{
		...
		Window window(title, Window::UNDEFINED, Window::UNDEFINED, 640, 480, Window::SHOWN);
...
//			framerate.update();
//			uint32_t fps = framerate.getFPS();
//			ostringstream os;
//			os << fps;
//
//			window.setTitle(title + string(" FPS:") + os.str());
		}
